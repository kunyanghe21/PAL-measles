...
One approach is to take advantage of the possibility to design the filter's prediction distribution for the $n$th observation, at time $t_n$, to take advantage of data ccurring at, or subsequent to, time $t_n$.
...
That decision simplifies the experimental design and permits the computional effort to focus on a few direct comparisons between the methods on a small number of simulated datasets.
...
$E_6$  & $`r sprintf('%.2f', E6_lambda)`$  & 
$`r sprintf('%.2f', E6_sigma)`$  & 
$`r sprintf('%.2f', E6_AMRA)`$  & 
$`r sprintf('%.2f', E6_NegB)`$ \\     
$E_7$  & $`r sprintf('%.2f', E7_lambda)`$  & 
$`r sprintf('%.2f', E7_sigma)`$  & 
$`r sprintf('%.2f', E7_AMRA)`$  & 
$`r sprintf('%.2f', E7_NegB)`$ \\  
$E_8$  & $`r sprintf('%.2f', E8_lambda)`$  & 
$`r sprintf('%.2f', E8_sigma)`$  & 
$`r sprintf('%.2f', E8_AMRA)`$  & 
$`r sprintf('%.2f', E8_NegB)`$ \\
$E_9$  & $`r sprintf('%.2f', E9_lambda)`$  & 
$`r sprintf('%.2f', E9_sigma)`$  & 
$`r sprintf('%.2f', E9_AMRA)`$  & 
$`r sprintf('%.2f', E9_NegB)`$ \\
$E_{10}$ & $`r sprintf('%.2f', E10_lambda)`$ & 
$`r sprintf('%.2f', E10_sigma)`$ & 
$`r sprintf('%.2f', E10_AMRA)`$ & 
$`r sprintf('%.2f', E10_NegB)`$ \\
$E_{11}$ & $`r sprintf('%.2f', E11_lambda)`$ & 
$`r sprintf('%.2f', E11_sigma)`$ & 
$`r sprintf('%.2f', E11_AMRA)`$ & 
$`r sprintf('%.2f', E11_NegB)`$ \\  
$E_{12}$ & $`r sprintf('%.2f', E12_lambda)`$ & 
$`r sprintf('%.2f', E12_sigma)`$ & 
$`r sprintf('%.2f', E12_AMRA)`$ & 
$`r sprintf('%.2f', E12_NegB)`$ \\   
$E_{13}$ & $`r sprintf('%.2f', E13_lambda)`$ & 
$`r sprintf('%.2f', E13_sigma)`$ & 
$`r sprintf('%.2f', E13_AMRA)`$ & 
$`r sprintf('%.2f', E13_NegB)`$ \\ 
$E_{14}$ & $`r sprintf('%.2f', E14_lambda)`$ & 
$`r sprintf('%.2f', E14_sigma)`$ & 
$`r sprintf('%.2f', E14_AMRA)`$ & 
$`r sprintf('%.2f', E14_NegB)`$ \\ 
$E_{15}$ & $`r sprintf('%.2f', E15_lambda)`$ & 
...
On this relatively easy task, it produces stable estimates, with log-likelihood values somewhat below the truth.
...
The difference, $\lambda_2-\lambda_3$, is statistically indistinguishable from zero in this experiment, showing that $J_1=1000$ particles is adequate for $\PALV$ on a single city.
...
However, increasing from $J_1=5\times 10^3$ to $J_2=10^5$ particles reduced the $\PALL$ estimate by  $\lambda_{15}-\lambda_{14}=$ `r sprintf('%.2f', E15_lambda-E14_lambda)` log units.
