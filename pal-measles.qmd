...
$E_{12}$ &  &  &  &  \\    
$E_{13}$ &  &  &  &  \\ 
$E_{14}$ & $`r sprintf('%.2f', E14_lambda)`$ & $`r sprintf('%.2f', E14_sigma)`$ & $`r sprintf('%.2f', E14_AMRA)`$ & $`r sprintf('%.2f', E14_NegB)`$ \\ 
$E_{15}$ & $`r sprintf('%.2f', E15_lambda)`$ & $`r sprintf('%.2f', E15_sigma)`$ & $`r sprintf('%.2f', E15_AMRA)`$ & $`r sprintf('%.2f', E15_NegB)`$ \\ 
\bottomrule
\end{tabular}
