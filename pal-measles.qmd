...
These results are tabulated in @tbl-method-comparison, together with benchmark log-likelihoods for a log-ARMA model and a negative binomial autoregressive model.
