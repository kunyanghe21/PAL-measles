...
On this relatively easy task, it produces stable estimates, with log-likelihood values somewhat below the truth.Add commentMore actions
...
However, the results are consistent with the results for a single unit and for simulated data with 40 independent cities.Add commentMore actions
